...
describe(type, function()
{
    ...
    {
        format(127).should.eql('壹佰贰拾柒、');
    });

    it('should format 200', function()
    {
        format(200).should.eql('贰佰、');
    });

    it('should format 255', function()
    {
        format(255).should.eql('贰佰伍拾伍、');
    });
