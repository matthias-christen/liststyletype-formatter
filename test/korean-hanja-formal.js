...
describe(type, function()
{
    ...
    {
        format(107).should.eql('壹百七、');
    });

    it('should format 117', function()
    {
        format(117).should.eql('壹百壹拾七、');
    });

    it('should format 127', function()
    {
        format(127).should.eql('壹百貳拾七、');
    });

    it('should format 200', function()
    {
        format(200).should.eql('貳百、');
    });

    it('should format 255', function()
    {
        format(255).should.eql('貳百五拾五、');
    });
